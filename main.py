...
def main():
    train_loss_history, train_acc_history, valid_loss_history, valid_acc_history,args = run()
...
def run():
    ...
    return train_loss_history, train_acc_history, valid_loss_history, valid_acc_history,args
